...
#MATERIAL PROPERTIES 
    ...
    Nodes_Coord,Element_Connect,Nodes_Vn,Nodes_Thickness=Mesh_Rect_Cyl.cylindrical_mesh(300,[90,0],300,4,4,3)
    ...
    bcdof,BC_nodes=BC_Cylin_Line([0,2],[300,0],[0,2,4],Nodes_Coord,bcdof,BC_nodes) #Corresponds to DA
    bcdof,BC_nodes=BC_Cylin_Line([0,1],[300,89.5],[0,4,5],Nodes_Coord,bcdof,BC_nodes) #Corresponds to DC
    bcdof,BC_nodes=BC_Cylin_Line([0,1],[300,0],[2,3,4],Nodes_Coord,bcdof,BC_nodes) #Corresponds to AB
    bcdof,BC_nodes=BC_Cylin_Line([0,2],[300,300],[1,3,5],Nodes_Coord,bcdof,BC_nodes) #Corresponds to CB
    ...
    R,F_nodes,F_components=Force_Cylin_Mesh([300,89.5,300],-2,0.25,Nodes_Coord,R,
