...
#Check the geometry by plotting it. 
    ...
    BC_nodes.append(1)
    bcdof=BC(2,[0,2],bcdof)
    BC_nodes.append(2)
    bcdof=BC(3,[0,2],bcdof)
    BC_nodes.append(3)
    bcdof=BC(4,[0,2],bcdof)
    BC_nodes.append(4)
    bcdof=BC(5,[0,2],bcdof)
    BC_nodes.append(5)
    bcdof=BC(6,[0,2],bcdof)
    BC_nodes.append(6)
    bcdof=BC(7,[0,2],bcdof)
    BC_nodes.append(7)
    bcdof=BC(8,[0,2],bcdof)
    BC_nodes.append(8)
    bcdof=BC(1,[1],bcdof)
    BC_nodes.append(2)
    bcdof=BC(2,[1],bcdof)
