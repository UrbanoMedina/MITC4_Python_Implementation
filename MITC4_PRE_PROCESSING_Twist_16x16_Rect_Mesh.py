...
#MATERIAL PROPERTIES 
    ...
    Nodes_Coord,Element_Connect,Nodes_Vn,Nodes_Thickness=Mesh_Rect_Cyl.rectangular_mesh(8,8,25,25,1)
    ...
    bcdof=BC(651,[0,1,2],bcdof)
    BC_nodes.append(651)
    
    bcdof=BC(676,[0,1,2],bcdof)
    BC_nodes.append(676)
    
    #Set all the inner BCs
    for i in range(Nodes_Coord.shape[0]):
        if i != 0 or i != 650 or i != 675:
